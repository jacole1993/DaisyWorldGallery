...
/**
 * REST controller for managing {@link com.daisyworld.domain.Photo}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Photo> result = photoRepository
            ...
            .map(existingPhoto -> {
                if (photo.getImageName() != null) {
                    existingPhoto.setImageName(photo.getImageName());
                }
                ...
                if (photo.getIsMomInPicture() != null) {
                    existingPhoto.setIsMomInPicture(photo.getIsMomInPicture());
                }
                if (photo.getIsDadInPicture() != null) {
                    existingPhoto.setIsDadInPicture(photo.getIsDadInPicture());
                }
                if (photo.getIsFamilyInPicture() != null) {
                    existingPhoto.setIsFamilyInPicture(photo.getIsFamilyInPicture());
                }
